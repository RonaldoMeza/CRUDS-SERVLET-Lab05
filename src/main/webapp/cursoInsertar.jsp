                ...
                <div class="card-body">
                    <form action="cController">
                        <div class="input-group mt-2">
                            ...
                            <input class="form-control" type="text" name="txtCodigo" id="nomcli" placeholder="Código" autofocus required>
                        </div>
                        <div class="input-group mt-2">
                            <label class="input-group-text">Nombres:</label>
                            <input class="form-control" type="text" name="txtNombre" id="apecli" placeholder="Nombres" required>
                        </div>
                        <div class="input-group mt-2">
                            <label class="input-group-text">Creditos</label>
                            <input class="form-control" type="text" name="txtCreditos" id="nrodmicli" placeholder="Creditos" required>
                        </div>
