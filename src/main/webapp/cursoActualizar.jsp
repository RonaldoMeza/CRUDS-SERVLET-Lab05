                ...
                <div class="card-body">
                    <form action="cController">
                        <div class="input-group mt-2">
                            ...
                            <input class="form-control" type="text" name="txtCodigo" id="nomcil" placeholder="Código" value="<%=curso.getCodigo() %>" readonly>
                        </div>
                        <div class="input-group mt-2">
                            <label class="input-group-text">Nombre</label>
                            <input class="form-control" type="text" name="txtNombre" id="apecil" placeholder="Nombre" value="<%=curso.getNombre() %>" autofocus required>
                        </div>
                        <div class="input-group mt-2">
                            <label class="input-group-text">Creditos</label>
                            <input class="form-control" type="text" name="txtCreditos" id="txtCreditos" value="<%=curso.getCreditos() %>" placeholder="Creditos" required>
                        </div>
